    ...
    <>
        <main className='relative bg-white '>
          <div className='fixed top-0 right-0 bottom-0 left-0'>
            <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-11/12 md:w-1/2 h-fit border-4 border-DodgerBlue dark:border-GoldenYellow rounded-xl
