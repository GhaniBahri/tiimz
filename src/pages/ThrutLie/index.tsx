            ...
            (
                <div className='w-full h-full flex flex-col justify-center items-center'>
                    <div className='border-4 border-DodgerBlue dark:border-GoldenYellow rounded-xl relative flex justify-between items-center w-11/12 md:w-1/2 h-fit mb-12 px-20 py-10 flex-col gap-10'>
                        ...
                        <input type="text" className='shadow-[0_0_8px_2px_rgba(0,0,0,0.15)] bg-gray-50 rounded-sm w-full h-16 outline-none border-b-2 border-Coralred text-Coralred px-3 text-3xl text-left font-medium' />
                        <input type="text" className='shadow-[0_0_8px_2px_rgba(0,0,0,0.15)] bg-gray-50 rounded-sm w-full h-16 outline-none border-b-2 border-Coralred text-Coralred px-3 text-3xl text-left font-medium' />
                    </div>
